...
/** Email sent when someone submits a Valentine's reservation request. */
...
<p style="margin:16px 0 0;font-size:15px;line-height:1.6;color:#c4bfb5;"><strong style="color:#d4af37;">Merci, nous avons bien reçu votre demande de réservation pour la Saint-Valentin.</strong></p>
<p style="margin:12px 0 0;font-size:15px;line-height:1.6;color:#c4bfb5;">Nous allons l'examiner et vous enverrons une confirmation avec le menu dès que nous l'aurons acceptée.</p>
<p style="margin:12px 0 0;font-size:15px;line-height:1.6;color:#c4bfb5;">À bientôt !</p></td></tr>
